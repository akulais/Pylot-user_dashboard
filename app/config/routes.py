...
# routes['/delete/<id>'] = 'Products#delete'
# routes['/edit/<id>'] = 'Products#edit'
# routes['/add_product'] = 'Products#add_product'
# routes['POST']['/add_products'] = 'Products#add_products'
# routes['POST']['/update/<id>'] = 'Products#update'
# routes['/show_product/<id>'] = 'Products#show_product'
"""
